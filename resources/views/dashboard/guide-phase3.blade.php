...
<head>
    ...
    <title>Panduan Phase 3 — CuanCapital</title>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .hero::before{content:'';position:absolute;inset:0;background:radial-gradient(ellipse 80% 60% at 50% -10%,rgba(59,130,246,.18),transparent);pointer-events:none}
        .hero-eyebrow{display:inline-flex;align-items:center;gap:8px;background:rgba(59,130,246,.12);border:1px solid rgba(59,130,246,.3);color:var(--theme);font-size:11px;font-weight:800;padding:6px 14px;border-radius:100px;letter-spacing:1px;text-transform:uppercase;margin-bottom:16px}
        ...
        .ic-theme{background:rgba(59,130,246,.15);color:var(--theme)}
        ...
        .step-num{width:30px;height:30px;border-radius:50%;flex-shrink:0;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:900; background:rgba(59,130,246,.2);color:var(--theme);border:1.5px solid rgba(59,130,246,.4)}
        ...
        .callout.tip{background:rgba(59,130,246,.08);border:1px solid rgba(59,130,246,.2)}
        ...
        .cta-section{text-align:center;padding:44px 20px;background:linear-gradient(135deg,rgba(59,130,246,.1),rgba(15,23,42,.1));border:1px solid rgba(255,255,255,.06);border-radius:20px;margin-top:40px}
        ...
        .btn-cta{display:inline-flex;align-items:center;gap:8px;background:var(--theme);color:#fff;font-size:14px;font-weight:800;padding:14px 24px;border-radius:12px;text-decoration:none;transition:all .2s;box-shadow:0 8px 24px rgba(59,130,246,.3)}
        .btn-cta:hover{background:var(--theme-dark);transform:translateY(-2px);box-shadow:0 12px 30px rgba(59,130,246,.4)}.btn-cta:active{transform:translateY(0)}
    </style>
</head>
<body>
...
<div class="hero">
    <div class="hero-eyebrow"><i class="fas fa-book-open"></i> Phase 3 Guide</div>
    <h1>Teman Curhat <span>Otomatis</span><br>Scale-Up Bisnis</h1>
    <p>Bingung kenapa bisnis stuck padahal kerja sudah keras? Biarkan engine ini yang membedah dan mencari simpul kemacetannya.</p>
</div>
<div class="guide-layout">
    ...
    <main class="content">
        <section class="section" id="s-overview">
            ...
            <h2>Fokus Ke Solusi, Bukan Amarah</h2>
            <p class="subtitle">Daripada marah-marah ke tim *sales* atau berasumsi sendiri, gunakan Mentor Virtual untuk merefleksikan laju bisnis yang murni berdasarkan data *historis* sebulan terakhir, tanpa intervensi *feeling* dari *owner*-nya.</p>
            <div class="callout tip"><div class="callout-icon"><i class="fas fa-lightbulb"></i></div><div class="callout-body"><strong>Filosofi Inti</strong><p>Mentor (konsultan Bisnis AI) tidak akan bisa dibohongi sentimen perasaanmu, dia murni bekerja menemukan masalah utama dari input data angkamu yang paling jujur.</p></div></div>
        </section>
        <section class="section" id="s-fungsi">
            <div class="section-tag"><i class="fas fa-crosshairs"></i> Fungsi</div>
            <h2>Apa Fungsi Fiturnya?</h2>
            <p class="subtitle">Teman diskusi (*consultancy*) otomatis yang mampu membedah titik macet omzet kamu berdasarkan indikator performa yang terjadi di lapangan.</p>
        </section>
        <section class="section" id="s-kerja">
            <div class="section-tag"><i class="fas fa-cogs"></i> Diagnostic Reasoning</div >
            <h2>Bagaimana Algoritma Ini Bekerja?</h2>
            <p class="subtitle">Mesin _Logical Reasoning_ kami memetakan input rasio *conversion*, omzet, dan modal. Algoritma kemudian mencocokkan pola buruknya dengan pangkalan data ratusan kasus _study-case_ lampau kami di lapangan untuk mengeluarkan <b>Output Diagnostik</b> (*Sales Team, Offer, atau Traffic Issue*).</p>
        </section>
        <section class="section" id="s-pakai">
            ...
            <p class="subtitle">Mulai lembar konsultasi baru ketika merasa bisnismu bulan ini berjalan stagnan.</p>
            <div class="steps">
                <div class="step"><div class="step-num">1</div><div class="step-body"><div class="step-title">Klik "Mulai Diagnosa"</div><div class="step-desc">Masuk ke sub-halaman Mentor Lab menggunakan tombol di halaman utama.</div></div></div>
                <div class="step"><div class="step-num">2</div><div class="step-body"><div class="step-title">Isi Form Wizard Data Performa</div><div class="step-desc">Jujurlah dalam mengisi data *Traffic, Leads*, modal iklan, dan nominal total *closing* di bulan kemarin. Ketidakjujuran menuntun AI kepada kebohongan simpulan.</div></div></div>
                <div class="step"><div class="step-num">3</div><div class="step-body"><div class="step-title">Tonton AI Bekerja</div><div class="step-desc">Proses kalkulasi indikator biasanya memakan sedikit waktu untuk membedah masalah.</div></div></div>
                <div class="step"><div class="step-num">4</div><div class="step-body"><div class="step-title">Pelajari Surat Instruksinya</div><div class="step-desc">Kamu akan disuguhi surat hasil rincian poin-poin *Action-Plan* (apa yang harus kamu benahi bulan depan, apakah itu penawaran/offer, cara balas cs, atau strategi ads-nya).</div></div></div>
            </div>
            <div class="callout tip"><div class="callout-icon"><i class="fas fa-star"></i></div><div class="callout-body"><strong>Interkonektivitas</strong><p>Setiap Action Plan itu sifatnya eksklusif untuk setiap *owner*. Poin poin panjangnya dapat kamu ubah jadi poin mainan (Roadmap Gamifikasi) pada tahapan (Phase) 4 kelak.</p></div></div>
        </section>
        <div class="cta-section">
            <h2>Mulai Sesi Curhatmu!</h2>
            <p>Berhenti kebingungan, temukan langsung kelemahannya lewat analisa engine ini.</p>
            <a href="{{ route('index') }}" class="btn-cta"><i class="fas fa-brain"></i> Konsultasi Sekarang</a>
        </div>
    </main>
</div>
<script>
