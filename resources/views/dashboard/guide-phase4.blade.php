...
<head>
    ...
    <title>Panduan Phase 4 — CuanCapital</title>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .hero::before{content:'';position:absolute;inset:0;background:radial-gradient(ellipse 80% 60% at 50% -10%,rgba(245,158,11,.18),transparent);pointer-events:none}
        .hero-eyebrow{display:inline-flex;align-items:center;gap:8px;background:rgba(245,158,11,.12);border:1px solid rgba(245,158,11,.3);color:var(--theme);font-size:11px;font-weight:800;padding:6px 14px;border-radius:100px;letter-spacing:1px;text-transform:uppercase;margin-bottom:16px}
        ...
        .ic-theme{background:rgba(245,158,11,.15);color:var(--theme)}
        ...
        .step-num{width:30px;height:30px;border-radius:50%;flex-shrink:0;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:900; background:rgba(245,158,11,.2);color:var(--theme);border:1.5px solid rgba(245,158,11,.4)}
        ...
        .callout.tip{background:rgba(245,158,11,.08);border:1px solid rgba(245,158,11,.2)}
        ...
        .cta-section{text-align:center;padding:44px 20px;background:linear-gradient(135deg,rgba(245,158,11,.1),rgba(15,23,42,.1));border:1px solid rgba(255,255,255,.06);border-radius:20px;margin-top:40px}
        ...
        .btn-cta{display:inline-flex;align-items:center;gap:8px;background:var(--theme);color:#fff;font-size:14px;font-weight:800;padding:14px 24px;border-radius:12px;text-decoration:none;transition:all .2s;box-shadow:0 8px 24px rgba(245,158,11,.3)}
        .btn-cta:hover{background:var(--theme-dark);transform:translateY(-2px);box-shadow:0 12px 30px rgba(245,158,11,.4)}.btn-cta:active{transform:translateY(0)}
    </style>
</head>
<body>
...
<div class="hero">
    <div class="hero-eyebrow"><i class="fas fa-book-open"></i> Phase 4 Guide</div>
    <h1>Eksekusi Strategi<span> & </span><br>Panen Hasilnya</h1>
    <p>Jangan sekedar menumpuk teori. Ubah hasil diagnosa dari Phase 3 menjadi satu rentetan ceklis tugas yang siap dicentang tiap harinya.</p>
</div>
<div class="guide-layout">
    ...
    <main class="content">
        <section class="section" id="s-overview">
            ...
            <h2>Mainkan Bisnismu Seperti Game</h2>
            <p class="subtitle">Daripada bingung membaca kalimat panjang instruksi mentor pada fase 3, kamu bisa meminta fitur Roadmap untuk menyulap kalimat-kalimat panjang itu menjadi format checklist gamifikasi (poin-poin).</p>
            <div class="callout tip"><div class="callout-icon"><i class="fas fa-lightbulb"></i></div><div class="callout-body"><strong>Filosofi Inti</strong><p>Kerjakan sedikit demi sedikit. Checklist harian adalah kunci menuju kebebasan omzet finansial tanpa perlu overthinking besok mau kerjain apa.</p></div></div>
        </section>
        <section class="section" id="s-fungsi">
            <div class="section-tag"><i class="fas fa-crosshairs"></i> Fungsi</div>
            <h2>Apa Fungsi Fiturnya?</h2>
            <p class="subtitle">Memecah laporan *Diagnostic/Action Plan* yang rumit menjadi daftar *To-Do List* (tugas) harian yang bisa dicentang (*checklist*) ketika kamu berhasil menuntaskan tugas tersebut di dunia nyata.</p>
        </section>
        <section class="section" id="s-kerja">
            <div class="section-tag"><i class="fas fa-cogs"></i> Gamification Mode</div >
            <h2>Bagaimana Algoritma Ini Bekerja?</h2>
            <p class="subtitle">Berbekal Prompt khusus gamifikasi kami, engine akan mengambil referensi blueprint kamu dari Phase 3 lalu membaginya menjadi fase-fase minggu. Setiap minggu (*week*) akan diisi dengan sub-tugas (*actionable items*) yang praktis beserta contoh referensi eksekusinya langsung.</p>
        </section>
        <section class="section" id="s-pakai">
            ...
            <p class="subtitle">Lakukan ini tepat setelah kamu selesai membaca surat keluhan dari Mentor AI di fase ke-3.</p>
            <div class="steps">
                <div class="step"><div class="step-num">1</div><div class="step-body"><div class="step-title">Klik Tombol Generate</div><div class="step-desc">Masuk ke tab Roadmap, lalu jika sudah ada blueprint hasil diskusi sebelumnya, klik saja *Build Gamified Execution Plan*.</div></div></div>
                <div class="step"><div class="step-num">2</div><div class="step-body"><div class="step-title">Klik Item untuk Mengeksekusi</div><div class="step-desc">Setiap poin ceklis tidak hanya berupa teks pendek. Klik poin tersebut untuk memunculkan kolom deskripsi detail beserta rekomendasi *resource*/tools yang bisa kamu pakai hari itu.</div></div></div>
                <div class="step"><div class="step-num">3</div><div class="step-body"><div class="step-title">Centang (Checklist) Keberhasilanmu</div><div class="step-desc">Jika poin tugas tersebut telah kamu lalui atau kamu delegasikan tuntas ke tim, centang kotaknya. Garis progresmu akan langsung naik perlahan.</div></div></div>
                <div class="step"><div class="step-num">4</div><div class="step-body"><div class="step-title">Panen Gamifikasi (*Level up*)</div><div class="step-desc">Tuntaskan seluruh ceklis di setiap minggunya untuk membangun *habit* bisnis positif dan melaju ke *Scale-Up* tahapan berikutnya.</div></div></div>
            </div>
            <div class="callout tip"><div class="callout-icon"><i class="fas fa-star"></i></div><div class="callout-body"><strong>Mindset Hack</strong><p>Kerjakan 1 poin yang paling gampang dan tidak memakan uang peser pun per harinya jika kamu sedang merasa *burn-out* (capek) berat.</p></div></div>
        </section>
        <div class="cta-section">
            <h2>Mulai Eksekusi Checklist-mu!</h2>
            <p>Jadikan proses peningkatan target semudah menyelesaikan misi permainan ponselmu.</p>
            <a href="{{ route('index') }}" class="btn-cta"><i class="fas fa-map-marked-alt"></i> Buka Strategy Roadmap</a>
        </div>
    </main>
</div>
<script>
