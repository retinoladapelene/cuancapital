...
<head>
    ...
    <title>Panduan Phase 1 — CuanCapital</title>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .btn-cta:hover{background:var(--theme-dark);transform:translateY(-2px);box-shadow:0 12px 30px rgba(16,185,129,.4)}.btn-cta:active{transform:translateY(0)}
    </style>
</head>
<body>
...
<div class="hero">
    <div class="hero-eyebrow"><i class="fas fa-book-open"></i> Phase 1 Guide</div>
    <h1>Memecah Target <span>Mustahil</span><br>Menjadi Realistis</h1>
    <p>Pelajari bagaimana merubah ekspektasi puluhan juta per bulan menjadi tindakan kecil yang wajib diselesaikan hari ini.</p>
</div>
...
<div class="guide-layout">
    ...
    <main class="content">
        ...
        <section class="section" id="s-overview">
            ...
            <h2>Fokus Ke Target Harian</h2>
            <p class="subtitle">Banyak pemula gagal karena target besarnya (contoh: profit 100 juta/bulan) terasa sangat jauh. Akibatnya motivasi mudah turun saat menemui hambatan.</p>
            <div class="callout tip"><div class="callout-icon"><i class="fas fa-lightbulb"></i></div><div class="callout-body"><strong>Filosofi Inti</strong><p>Reverse Goal Planner akan membalikkan paradigma: "Apa yang harus saya capai dalam 1 bulan?" menjadi <strong>"Berapa closing yang WAJIB saya dapatkan hari ini?"</strong></p></div></div>
        </section>
        ...
        <section class="section" id="s-fungsi">
            ...
            <p class="subtitle">Mendiagnosis realistis-tidaknya target *net profit* bulanan yang kamu minta, lalu memecahnya secara kejam hingga menjadi satu Angka Target Harian.</p>
        </section>

        <!-- CARA KERJA -->
        <section class="section" id="s-kerja">
            <div class="section-tag"><i class="fas fa-cogs"></i> Balik Kap</div >
            <h2>Bagaimana Algoritma Ini Bekerja?</h2>
            <p class="subtitle">Sistem memotong angka Biaya Operasional (*Fixed Cost*) dan Modal Barang (HPP) untuk menemukan **Margin Keuntungan Bersih** dari satu penjualan.</p>
            <p class="subtitle">Setelah Margin terekam, sistem membagi target bulanan (Total Laba) dengan Margin untuk mendapatkan Kuota Penjualan (dalam *Quantity*), lalu dibagi atas jumlah hari kerja optimal.</p>
        </section>
        ...
        <section class="section" id="s-pakai">
            ...
            <p class="subtitle">Ikuti urutan ini dengan teliti saat pertama kali login.</p>
            <div class="steps">
                <div class="step"><div class="step-num">1</div><div class="step-body"><div class="step-title">Masukkan Target Profit Bersih</div><div class="step-desc">Tulis berapa rupiah *clear profit* (laba murni yang kamu bawa pulang) bulan ini. Masukkan di form yang disediakan.</div></div></div>
                <div class="step"><div class="step-num">2</div><div class="step-body"><div class="step-title">Tulis Perkiraan Biaya Operasional</div><div class="step-desc">Masukkan biaya berlangganan wifi, asisten/admin (jika ada), kuota, atau listrik. Jika belum ada tidak apa-apa kosongi atau tulis 0.</div></div></div>
                <div class="step"><div class="step-num">3</div><div class="step-body"><div class="step-title">Klik "Simulate Profit"</div><div class="step-desc">Tekan tombol *calculate* dan baca angka keluaran (*output*) di layar metrik sebelah kanan.</div></div></div>
                <div class="step"><div class="step-num">4</div><div class="step-body"><div class="step-title">Ambil Action Target Harian</div><div class="step-desc">Perhatikan angka <b>"Target Closing Harian"</b>. Itulah KPI harian kamu. Jangan berhenti beriklan atau membalas chat sebelum angka itu tercetak hijau *DONE* tiap harinya.</div></div></div>
            </div>
            <div class="callout tip"><div class="callout-icon"><i class="fas fa-star"></i></div><div class="callout-body"><strong>Kebiasaan yang mengubah segalanya</strong><p>Tempelkan angka target harian itu di dinding kamarmu agar kamu tidak pernah lupa apa *goals* kecil yang harus dikejar!</p></div></div>
        </section>

        <div class="cta-section">
            <h2>Siap Kalkulasi?</h2>
            <p>Bongkar target bulanan kamu menjadi kepingan tugas harian sekarang.</p>
            <a href="{{ route('index') }}" class="btn-cta"><i class="fas fa-bullseye"></i> Buka Reverse Planner</a>
        </div>
    </main>
</div>
